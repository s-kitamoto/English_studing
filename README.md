...
- **復習**: SM-2 ベースのフラッシュカード。評価は **Again / Perfect の2ボタン**だけで、迷わず進められる。ブラウザ内蔵の音声合成で発音再生、キーボード操作対応
- **一覧**: 全文検索、種別・品詞・状態での絞り込み、並び替え、行ごとの発音再生、編集、論理削除と復元、休止
...
- [要件定義 v0.5](docs/requirements.md)
